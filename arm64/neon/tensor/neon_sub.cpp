 ...
 * @brief NEON_SIMD implementation of Tensor Subtraction
 * @version 0.1
 * @date 2023-01-03
 * 
...
/**
 * @brief NEON_SIMD accelerated Tensor Subtraction function:
 * 
 * @param a first operand tensor
 * @param b second operand tensor
 * @param c output tensor
 */
void neon_sub(const Tensor a, const Tensor b, Tensor &c){    
    ...
    vst1q_f32(c[0], vsubq_f32(Ta0, Tb0));
    vst1q_f32(c[1], vsubq_f32(Ta1, Tb1));
    vst1q_f32(c[2], vsubq_f32(Ta2, Tb2));
    vst1q_f32(c[3], vsubq_f32(Ta3, Tb3));
}
